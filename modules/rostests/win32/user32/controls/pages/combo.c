...
/*
 * +------------------------------------------+
 * | [ Simple Combo   ]    [ Dropdown      v] |
 * | | Cherry         |    [ Sorted List   v] |
 * | | Datena         |    [ Drop-List     v] |
 * | | Grapey         |    [ Extended UI   v] |
 * | | Apple          |    [ Disabled      v] |
 * | | Banana         |    [ Uppercase     v] |
 * | | Fig            |    [ Lowercase     v] |
 * | | Elderberry     |    [ No Integral   v] |
 * +------------------------------------------+
 */
...
InitPage(HWND Parent, PCOMBOBOX_PAGE_DATA PageData)
{
    ...
    PageData->hSimpleCombo = CreateChild(IDC_SIMPLE_COMBO,
                                         L"COMBOBOX",
                                         L"Simple Combo",
    ...
    PageData->hDropdownCombo = CreateChild(IDC_DROPDOWN_COMBO,
                                           L"COMBOBOX",
                                           L"Editable Text",
    ...
    PageData->hDropdownListCombo = CreateChild(IDC_DROPDOWNLIST_COMBO,
                                               L"COMBOBOX",
                                               L"",
    ...
    PageData->hDisabledCombo = CreateChild(IDC_DISABLED_COMBO,
                                           L"COMBOBOX",
                                           L"",
    ...
    PageData->hSortedCombo = CreateChild(IDC_SORTED_COMBO,
                                         L"COMBOBOX",
                                         L"",
    ...
    PageData->hExtendedUICombo = CreateChild(IDC_EXTENDEDUI_COMBO,
                                             L"COMBOBOX",
                                             L"",
                                             CBS_DROPDOWNLIST | WS_VSCROLL,
                                             180, 230, 140, 140,
    ...
    PageData->hAutoHScrollCombo = CreateChild(IDC_AUTOHSCROLL_COMBO,
                                              L"COMBOBOX",
                                              L"Type a very long string here...",
    ...
    PageData->hUppercaseCombo = CreateChild(IDC_UPPERCASE_COMBO,
                                            L"COMBOBOX",
                                            L"all caps",
    ...
    PageData->hLowercaseCombo = CreateChild(IDC_LOWERCASE_COMBO,
                                            L"COMBOBOX",
                                            L"ALL LOWER",
    ...
    PageData->hNoIntegralCombo = CreateChild(IDC_NOINTEGRAL_COMBO,
                                             L"COMBOBOX",
                                             L"",
